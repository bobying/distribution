...
public class CurrencyResourceIntTest {
    ...
    public void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.getDesc()).isEqualTo(DEFAULT_DESC);
    ...
    @Test
    @Transactional
    public void getAllCurrenciesByStatusIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the currencyList where status equals to statusId
        defaultCurrencyShouldBeFound("statusId.equals=" + statusId);

        // Get all the currencyList where status equals to statusId + 1
        defaultCurrencyShouldNotBeFound("statusId.equals=" + (statusId + 1));
    }
    ...
    public void updateCurrency() throws Exception {
        ...
        assertThat(testCurrency.getDesc()).isEqualTo(UPDATED_DESC);
